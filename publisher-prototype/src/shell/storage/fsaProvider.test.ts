...
import { createFsaProvider, type FsaWindow } from "./fsaProvider";
import type { HandleStore, RecentFileEntry } from "./handleStore";

/**
 * The FSA tier over injected fakes (PLAN.md §6.9 testing note): Playwright
