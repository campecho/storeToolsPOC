 ...
 * numeric entry applies as it is typed, and one visit to a field is EXACTLY
 * ONE history entry (the §6.3 one-entry-per-gesture rule applied to panel
 * commits, through the NumberField edit run), verified by the
