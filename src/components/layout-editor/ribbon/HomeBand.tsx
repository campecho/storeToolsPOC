    ...
    <>
      ...
      <RibbonGroup label="Styles">
        <FaceSelect
          ...
          testId="style-select"
          label="Text style"
          className="flex h-[26px] w-[130px] items-center justify-between rounded-[5px] border border-[#d6d6d6] bg-white px-[9px] text-[11px] text-[#555]"
        />
        <div className="flex gap-[5px]">
          <button
            ...
            className={`flex h-[22px] items-center rounded-[5px] border border-[#e0e0e0] bg-white px-2 text-[11px] font-bold text-[#555] ${
