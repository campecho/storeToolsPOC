...
export function ReportModal() {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed left-1/2 top-1/2 z-[51] flex max-h-[min(830px,calc(100vh-40px))] w-[660px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[14px] bg-white shadow-[0_24px_64px_rgba(0,0,0,.28)] ${
