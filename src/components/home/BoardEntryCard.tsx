...
export function BoardEntryCard() {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[10px] border border-dashed border-[#d8d8d8] bg-[#fbfbfb] px-[18px] py-4 sm:flex-row sm:items-center sm:gap-4">
      ...
      <Link
        ...
        className="shrink-0 cursor-pointer whitespace-nowrap text-[12px] font-semibold text-brand"
      >
        Open the board →
      </Link>
    </div>
